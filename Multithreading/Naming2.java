...
class ThreadName extends Thread
{
	...
	{
		//invoking the constructor ov the superclass,which is Thread class
		super(threadName);
	}
...
public class Naming2
{
	...
	{
		//creating two thrads and setting their name using the constructor of the class
		ThreadName th1=new ThreadName("JavaTpoint1");
		ThreadName th2=new ThreadName("JavaTpoint2");
		
		//invoking the getName() method to get the name of the thread created above
