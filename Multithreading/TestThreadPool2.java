...
class ThreadPool2 implements Runnable
{
	...
	{
		//initializing the fields taskName
		taskName=str;
	}
	//Printing the task name and then sleeps for 1sec
	//The complete process is getting reapeated five times
	public void run()
	{
		try
		{
			for(int j=0;j<=5;j++)
		   {
			 if(j==0)
			 {
				...
				//prints the initializing time for every task
...
public class TestThreadPool2
{
	...
	public static void main(String arg[])
	{
		...
		Runnable rb1=new ThreadPool2("task 1");
		Runnable rb2=new ThreadPool2("task 2");
		Runnable rb3=new ThreadPool2("task 3");
		Runnable rb4=new ThreadPool2("task 4");
		Runnable rb5=new ThreadPool2("task 5");
